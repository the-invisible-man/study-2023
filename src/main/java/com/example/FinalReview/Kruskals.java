...
public class Kruskals {
    /*
     * Implementation fo Kruskal's minimum spanning tree algorithm
     * Weighted, undirected graph
     *
     * We need a weighted adjacency list
     */
    public static void main(String[] args) {
        int[][] edges = new int[18][3];
        UnionFind uf = new UnionFind(18);
        ...
        for (int[] edge: edges) {
            ...
            minSpanningTreeWeight += edge[2];
        }

        System.out.println("The weight of the minimum spanning tree is " + minSpanningTreeWeight);
    }
